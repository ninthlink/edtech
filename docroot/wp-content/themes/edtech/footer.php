...
?>
  ...
  <footer id="footer">
    <div id="footer-top">
      <div class="wrap"><?php if (!function_exists('dynamic_sidebar') || !dynamic_sidebar('Footer Top')) :
endif; ?></div>
    </div>
    <div id="footer-bottom">
      <div class="wrap"><?php if (!function_exists('dynamic_sidebar') || !dynamic_sidebar('Footer Bottom')) :
endif; ?></div>
    </div>
  </footer>
